function(DownloadSDK platform version download_dir)
  ...
  set(SDK_ROOT "${SDK_DOWNLOAD_DIR}/YoumeVideoSDK_for_${platform}" CACHE INTERNAL "SDK_ROOT")
  ...
  if(NOT IS_DIRECTORY "${SDK_ROOT}")
    ...
    if(NOT EXISTS "${SDK_DOWNLOAD_PATH}")
      set(SDK_DOWNLOAD_URL "https://dl2-cdn.youme.im/release/${SDK_DOWNLOAD_FILENAME}")
